...
It does not publish the closed-source MCDO solver implementation, internal implementation details, internal implementation details or internal method structure.
...
| R(4,5)_d12_R | selected_closed_source_configuration | 3 | 369.6276923076923 | None | None | None |
| R(3,8)_d7_B | selected_closed_source_configuration | 3 | 1254.5434681242336 | None | None | None |
| R(4,7)_d20_R | selected_closed_source_configuration | 3 | 1254.5402869749746 | None | None | None |
| R(3,8)_d6_B | selected_closed_source_configuration | 3 | 2.1123084916423407 | None | None | None |

## Public claims ledger

| id | claim | status | disclosed | not disclosed |
|---|---|---|---|---|
| P1 | The project uses a closed-source MCDO solver and public certificate checks. | DISCLOSED | Results, validation outputs, timing, hardware, SHA256 manifests. | Solver implementation, internal implementation details, internal implementation details, internal MCDO structure. |
...
The MCDO solver is closed-source in this release. Public artifacts include benchmark outputs, validation tables, timing results, hardware metadata and SHA256 manifests. The repository does not disclose the internal search strategy or private reduction mechanism.
...
The reported timings were obtained using the closed-source MCDO solver build selected for this report. Internal solver variants, internal implementation details, internal implementation details, rule selection, and implementation details are not disclosed.
